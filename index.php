...
<body>
    ...
    <div class="content w-4/5 mx-auto">
        <div class="w-full mt-12 flex">
            <div class="w-1/2 text-justify pr-20">
            <p class="text-5xl mb-1 font-bold">
                Hey friends —
            </p>
            <p class="text-3xl mb-3">Mình là Kiều Ly, Mình đến từ một ngôi làng nhỏ tại Việt Nam và đang theo học ngành Thương Mại điện tử. 🎉</p>
        ...
        <div class="mt-3">
            <p class="text-2xl" style="font-family : 'Gloria Hallelujah', cursive;">Sở thích mình hay làm vào những TG rảnh</p>
            <div class="ml-72 mt-3">
        ...
        <div class="w-full flex item-center justify-between mt-6">
            <div class="h-60 border-2 border-solid border-gray-100 shadow-xl rounded-lg p-6 item__information 
            flex items-center justify-center cursor-pointer" style="width : 325px;box-shadow: 0 4px 10px rgba(0,0,0,0.2);
            transition: color 0.3s, transform 0.3s !important;">
                <div>
                    <p class="text-center text-4xl mb-3">📚</p>
                    <p class="font-bold text-2xl text-center mb-2">Đọc sách</p>
                    <p class="text-center text-black">Giúp cải thiện độ tập trung và khám phá những điều tốt lẫn xấu trong c/s.</p>
                </div>
            </div>
            <div class="h-60 border-2 border-solid border-gray-100 shadow-xl rounded-lg p-6 item__information 
            flex items-center justify-center cursor-pointer" style="width : 325px;box-shadow: 0 4px 10px rgba(0,0,0,0.2);
            transition: color 0.3s, transform 0.3s !important;">
                <div>
                    <p class="text-center text-4xl mb-3">🚀</p>
                    <p class="font-bold text-2xl text-center mb-2">Anime</p>
                    <p class="text-center text-black">One piece - Đây là bộ anime yêu thích, và cho tôi nhiều cảm xúc và hoài bão riêng của bản thân. </p>
                </div>
            </div>
            <div class="h-60 border-2 border-solid border-gray-100 shadow-xl rounded-lg p-6 item__information 
            flex items-center justify-center cursor-pointer" style="width : 325px;box-shadow: 0 4px 10px rgba(0,0,0,0.2);
            transition: color 0.3s, transform 0.3s !important;">
                <div>
                    <p class="text-center text-4xl mb-3">🎨</p>
                    <p class="font-bold text-2xl text-center mb-2">Thiết kế</p>
                    <p class="text-center text-black">Ngắm SG chụp ảnh và tự vẽ những bức tranh về sống sống đơn sơ, mộc mạc là những điều tuyệt vời nhất</p>
                </div>
            </div>
        </div>
    </div>
